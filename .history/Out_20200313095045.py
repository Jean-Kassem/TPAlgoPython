...
class Out:
    ...
    def __init__(self, ref_fournisseur, designation, litrage, conditionnement, code_barre, prix_achat, prix_vente, _type, modele, marque):
        self.set_ref_fournisseur(ref_fournisseur)
